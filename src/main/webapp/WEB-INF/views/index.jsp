      ...
      <div class="editorial-common">
         ...
         <div class="ng-star-inserted">
            <section class="block-text">
               ...
               <p class="editorial-block-intro">진저 옐로우, 말라카이트 그린, 버밀리언 레드가 가을 패션을 밝혀줍니다.</p>
               <p class="editorial-block-intro"><a data-cta-spa="" href="#">Discover our selection</a></p>
            </section>
         </div>
         <div class="ng-star-inserted">
         ...
         <div class="ng-star-inserted">
            <section class="block-text">
               ...
               <p class="editorial-block-intro">에르메스 라이프스타일이 모든 감각을 일깨우는 오브제와 함께 욕실까지 확장됩니다. 에르메스 인장이 새겨진 장식적이고 리필이 가능한
                  이 보틀에는 COLOGNES &amp; PARFUMS-JARDINS 컬렉션의 상징적인 향이 담겨있습니다. EAU DE CITRON NOIR, EAU D'ORANGE VERTE 및
                  EAU DE RHUBARBE ÉCARLATE 향기가 거품으로 변신합니다!</p>
               <p class="editorial-block-intro"><a href="#">르 뱅 에르메스를 즐겨보세요</a></p>
            </section>
         </div>
         <div class="ng-star-inserted">
            <section class="block_hero_media">
