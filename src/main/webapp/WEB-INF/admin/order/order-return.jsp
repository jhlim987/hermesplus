...
<%@ include file="/WEB-INF/admin/order/order-common.jsp" %>
							...
							<form class="row row-cols-md-auto g-1 align-items-center">
								<div class="col-12">
									...
									<div class="form-check-inline">
										<input class="form-check-input" type="checkbox" value="" id="">
										<label>반품처리중(수거전)</label>
									</div>
									<div class="form-check-inline">
										<input class="form-check-input" type="checkbox" value="" id="">
										<label>반품처리중(환불전)</label>
									</div>
									<div class="form-check-inline">
										<input class="form-check-input" type="checkbox" value="" id="">
										<label>반품처리중(환불보류)</label>
									</div>
									<div class="form-check-inline">
										<input class="form-check-input" type="checkbox" value="" id="">
										<label>반품완료</label>
						...
						<div class="card-body p-4 ">
							...
							<div class="mb-2 d-flex justify-content-between align-items-center">
								...
								<select class="form-select form-select-sm width-120px">
									<option>주문일순</option>
									<option>주문일역순</option>
									<option>반품신청일순</option>
									<option>반품신청일역순</option>
								</select>
								<select class="form-select form-select-sm width-120px">
								...
								<table class="table  table-bordered align-middle">
									<thead class="text-center">
										<tr>
											...
											<th scope="col">취소 품목별 주문번호</th>
											<th scope="col">주문자</th>
											<th scope="col">상품명</th>
											<th scope="col">주문수량</th>
											<th scope="col">반품수량</th>
											<th scope="col">총 상품구매금액</th>
											<th scope="col">반품환불금액</th>
