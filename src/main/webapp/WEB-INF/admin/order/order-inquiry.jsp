...
<%@ include file="/WEB-INF/admin/order/order-common.jsp" %>
							...
							<label class="form-label pt-3">주문상태:</label>
								...
								<table class="table  table-bordered align-middle">
									...
									<tbody class="text-center ">
										<tr>
											...
											<td>N</td>
											<td>N</td>
											<td><button type="button" class="btn btn-outline-primary btn-sm">삭제</button></td>
											<td>그 한가인 맞음</td>
										</tr>
									</tbody>
								</table>
